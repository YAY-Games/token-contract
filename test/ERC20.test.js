...
contract('ERC20', function (accounts) {
  ...
  shouldBehaveLikeERC20('BEP20', initialSupply, initialHolder, recipient, anotherAccount);
        ...
        describe('when there was no approved amount before', function () {
          it('reverts', async function () {
            await expectRevert(this.token.decreaseAllowance(
              spender, amount, { from: initialHolder }), 'BEP20: decreased allowance below zero',
            );
          });
        });
  ...
  describe('increase allowance', function () {
    ...
    describe('when the spender is the zero address', function () {
      ...
      it('reverts', async function () {
        await expectRevert(
          this.token.increaseAllowance(spender, amount, { from: initialHolder }), 'BEP20: approve to the zero address',
        );
      });
    });
  });
  ...
  describe('_mint', function () {
    ...
    it('rejects a null account', async function () {
      await expectRevert(
        this.token.mint(ZERO_ADDRESS, amount), 'BEP20: mint to the zero address',
      );
    });
  ...
  describe('_transfer', function () {
    shouldBehaveLikeERC20Transfer('BEP20', initialHolder, recipient, initialSupply, function (from, to, amount) {
  ...
  describe('_approve', function () {
    shouldBehaveLikeERC20Approve('BEP20', initialHolder, recipient, initialSupply, function (owner, spender, amount) {
